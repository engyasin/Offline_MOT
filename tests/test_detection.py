...
class Test_detection(unittest.TestCase):
    ...
    def test_detect(self):
        ...
        detector  = YoloDetector(os.path.join('model','yolov4-obj.cfg'),
                        os.path.join('model','Yolov4_epoch300.pth'),use_cuda=False)
        r = detector.detect(os.path.join('model','00120.jpg'))
    ...
    def test_better_detection(self):
        detector  = YoloDetector(os.path.join('model','yolov4-obj.cfg'),
                        os.path.join('model','Yolov4_epoch300.pth'),use_cuda=False)
        r = detector.better_detection(os.path.join('model','00120.jpg'))
